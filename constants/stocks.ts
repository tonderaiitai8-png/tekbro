...
export const STOCK_DATABASE: StockData[] = [
    ...
    // Semiconductors
    { symbol: 'NVDA', name: 'NVIDIA Corp.', sector: 'Tech', basePrice: 495.20, volatility: 0.030, description: 'Graphics processing units and AI chips', icon: '🖥️' },
    ...
    { symbol: 'TSM', name: 'Taiwan Semiconductor', sector: 'Tech', basePrice: 98.50, volatility: 0.022, description: 'Chip foundry services', icon: '⚙️' },
    ...
    { symbol: 'CRM', name: 'Salesforce Inc.', sector: 'Tech', basePrice: 220.40, volatility: 0.022, description: 'CRM software platform', icon: '💼' },
    { symbol: 'ADBE', name: 'Adobe Inc.', sector: 'Tech', basePrice: 560.90, volatility: 0.020, description: 'Creative software suite', icon: '🎨' },
    { symbol: 'NOW', name: 'ServiceNow Inc.', sector: 'Tech', basePrice: 680.50, volatility: 0.024, description: 'Enterprise workflow software', icon: '🔄' },
    ...
    { symbol: 'NET', name: 'Cloudflare Inc.', sector: 'Tech', basePrice: 78.40, volatility: 0.030, description: 'Web infrastructure', icon: '🌐' },
    { symbol: 'MDB', name: 'MongoDB Inc.', sector: 'Tech', basePrice: 385.60, volatility: 0.026, description: 'NoSQL database', icon: '🍃' },
    { symbol: 'PLTR', name: 'Palantir Technologies', sector: 'Tech', basePrice: 18.90, volatility: 0.035, description: 'Big data analytics', icon: '🔮' },
    ...
    { symbol: 'EA', name: 'Electronic Arts', sector: 'Tech', basePrice: 135.80, volatility: 0.020, description: 'Video game publisher', icon: '🕹️' },
    ...
    // Major Banks
    { symbol: 'JPM', name: 'JPMorgan Chase', sector: 'Finance', basePrice: 155.40, volatility: 0.018, description: 'Investment banking', icon: '🏛️' },
    ...
    { symbol: 'ALL', name: 'Allstate Corp.', sector: 'Finance', basePrice: 135.20, volatility: 0.018, description: 'Insurance services', icon: '🤝' },
    ...
    { symbol: 'MRK', name: 'Merck & Co.', sector: 'Healthcare', basePrice: 108.70, volatility: 0.016, description: 'Pharmaceutical research', icon: '⚗️' },
    ...
    { symbol: 'GILD', name: 'Gilead Sciences', sector: 'Healthcare', basePrice: 78.30, volatility: 0.018, description: 'Antiviral drugs', icon: '🛡️' },
    ...
    { symbol: 'DHR', name: 'Danaher Corp.', sector: 'Healthcare', basePrice: 245.80, volatility: 0.018, description: 'Life sciences', icon: '⚕️' },
    ...
    { symbol: 'CVX', name: 'Chevron Corp.', sector: 'Energy', basePrice: 155.80, volatility: 0.020, description: 'Energy corporation', icon: '🛢️' },
    { symbol: 'COP', name: 'ConocoPhillips', sector: 'Energy', basePrice: 118.40, volatility: 0.024, description: 'Oil exploration', icon: '🔍' },
